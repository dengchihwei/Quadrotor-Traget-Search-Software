...
void SettingsUpdatedCb(UAVObjEvent * ev)
{
	...
	if (ev == NULL || ev->obj == stabilizationSettingsHandle())
	{
		...
		pid_configure(&pids[PID_RATE_ROLL],
		              stabilizationSettings.RollRatePID[STABILIZATIONSETTINGS_ROLLRATEPID_KP],
		              stabilizationSettings.RollRatePID[STABILIZATIONSETTINGS_ROLLRATEPID_KI],
		              stabilizationSettings.RollRatePID[STABILIZATIONSETTINGS_ROLLRATEPID_KD],
		              stabilizationSettings.RollRatePID[STABILIZATIONSETTINGS_ROLLRATEPID_ILIMIT]);

		// Set the pitch rate PID constants
		pid_configure(&pids[PID_RATE_PITCH],
		              stabilizationSettings.PitchRatePID[STABILIZATIONSETTINGS_PITCHRATEPID_KP],
		              stabilizationSettings.PitchRatePID[STABILIZATIONSETTINGS_PITCHRATEPID_KI],
		              stabilizationSettings.PitchRatePID[STABILIZATIONSETTINGS_PITCHRATEPID_KD],
		              stabilizationSettings.PitchRatePID[STABILIZATIONSETTINGS_PITCHRATEPID_ILIMIT]);

		// Set the yaw rate PID constants
		pid_configure(&pids[PID_RATE_YAW],
		              stabilizationSettings.YawRatePID[STABILIZATIONSETTINGS_YAWRATEPID_KP],
		              stabilizationSettings.YawRatePID[STABILIZATIONSETTINGS_YAWRATEPID_KI],
		              stabilizationSettings.YawRatePID[STABILIZATIONSETTINGS_YAWRATEPID_KD],
		              stabilizationSettings.YawRatePID[STABILIZATIONSETTINGS_YAWRATEPID_ILIMIT]);

		// Set the roll attitude PI constants
		pid_configure(&pids[PID_ATT_ROLL],
		              stabilizationSettings.RollPI[STABILIZATIONSETTINGS_ROLLPI_KP],
		              stabilizationSettings.RollPI[STABILIZATIONSETTINGS_ROLLPI_KI], 0,
		              stabilizationSettings.RollPI[STABILIZATIONSETTINGS_ROLLPI_ILIMIT]);

		// Set the pitch attitude PI constants
		pid_configure(&pids[PID_ATT_PITCH],
		              stabilizationSettings.PitchPI[STABILIZATIONSETTINGS_PITCHPI_KP],
		              stabilizationSettings.PitchPI[STABILIZATIONSETTINGS_PITCHPI_KI], 0,
		              stabilizationSettings.PitchPI[STABILIZATIONSETTINGS_PITCHPI_ILIMIT]);

		// Set the yaw attitude PI constants
		pid_configure(&pids[PID_ATT_YAW],
		              stabilizationSettings.YawPI[STABILIZATIONSETTINGS_YAWPI_KP],
		              stabilizationSettings.YawPI[STABILIZATIONSETTINGS_YAWPI_KI], 0,
		              stabilizationSettings.YawPI[STABILIZATIONSETTINGS_YAWPI_ILIMIT]);

		// Set the vbar roll settings
		pid_configure(&pids[PID_VBAR_ROLL],
		              stabilizationSettings.VbarRollPID[STABILIZATIONSETTINGS_VBARROLLPID_KP],
		              stabilizationSettings.VbarRollPID[STABILIZATIONSETTINGS_VBARROLLPID_KI],
		              stabilizationSettings.VbarRollPID[STABILIZATIONSETTINGS_VBARROLLPID_KD],
		              0);

		// Set the vbar pitch settings
		pid_configure(&pids[PID_VBAR_PITCH],
		              stabilizationSettings.VbarPitchPID[STABILIZATIONSETTINGS_VBARPITCHPID_KP],
		              stabilizationSettings.VbarPitchPID[STABILIZATIONSETTINGS_VBARPITCHPID_KI],
		              stabilizationSettings.VbarPitchPID[STABILIZATIONSETTINGS_VBARPITCHPID_KD],
		              0);

		// Set the vbar yaw settings
		pid_configure(&pids[PID_VBAR_YAW],
		              stabilizationSettings.VbarYawPID[STABILIZATIONSETTINGS_VBARYAWPID_KP],
		              stabilizationSettings.VbarYawPID[STABILIZATIONSETTINGS_VBARYAWPID_KI],
		              stabilizationSettings.VbarYawPID[STABILIZATIONSETTINGS_VBARYAWPID_KD],
		              0);

		// Set the coordinated flight settings
		pid_configure(&pids[PID_COORDINATED_FLIGHT_YAW],
		              stabilizationSettings.CoordinatedFlightYawPI[STABILIZATIONSETTINGS_COORDINATEDFLIGHTYAWPI_KP],
		              stabilizationSettings.CoordinatedFlightYawPI[STABILIZATIONSETTINGS_COORDINATEDFLIGHTYAWPI_KI],
		              0, /* No derivative term */
		              stabilizationSettings.CoordinatedFlightYawPI[STABILIZATIONSETTINGS_COORDINATEDFLIGHTYAWPI_ILIMIT]);
